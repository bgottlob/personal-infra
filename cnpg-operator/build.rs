...
fn main() -> anyhow::Result<()> {
    ...
    helm::pull(REPO_NAME, CNPG_CHART_NAME, CNPG_CHART_VERSION, out_path)?;
    helm::pull(REPO_NAME, BARMAN_CHART_NAME, BARMAN_CHART_VERSION, out_path)?;
    ...
    let cnpg_template = helm::template(CNPG_CHART_NAME, CNPG_CHART_VERSION, NAMESPACE, Some(CNPG_CHART_NAME), None, out_path)?;
    let barman_template = helm::template(BARMAN_CHART_NAME, BARMAN_CHART_VERSION, NAMESPACE, Some(BARMAN_CHART_NAME), None, out_path)?;
